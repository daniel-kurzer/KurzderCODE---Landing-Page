...
const FeatureSection = () => {
    return (
        <div id="Features" className="relative mt-20 pt-20 border-b border-neutral-800 min-h-[800px]">
            ...
            <div className="flex flex-wrap mt-10 lg:mt-20">
                {features.map((feature, index) => (
                    <div key={index} className="w-full sm:1/2 lg:w-1/3">
                        <div className="flex">
                            <div className="flex mx-6 h-10 p-2 bg-neutral-900 text-teal-700 justify-center items-center rounded-full">
                                {feature.icon}
                            </div>
                            <div>
